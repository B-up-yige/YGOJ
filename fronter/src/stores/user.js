...
export const PERMISSIONS = {
  ...
  PERM_SOLUTION_VIEW: 5,
  PERM_SOLUTION_CREATE: 6,
  PERM_RECORD_VIEW: 7,
  PERM_RANKING_VIEW: 8,
  PERM_CONTEST_CREATE: 9,
  PERM_CONTEST_MANAGE: 10,
  PERM_CONTEST_JOIN: 11,
  PERM_PROBLEMSET_CREATE: 12,
  PERM_PROBLEMSET_MANAGE: 13,
  PERM_PROBLEMSET_VIEW: 14,
  PERM_USER_MANAGE: 15,
  PERM_SYSTEM_CONFIG: 16,
}
